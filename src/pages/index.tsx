          ...
          <div className={clsx('flex flex-col space-y-4 text-white z-10')}>
                ...
                >
                  ...
                  {arStarted && (
                    <>
                      ...
                      <div className='absolute text-[#745CF6] text-lg font-semibold border-b border-[#745CF6] w-full top-2/3 flex items-center justify-center -translate-y-1/2'>
                        <Link to='/product'>
            ...
            <div className='md:hidden flex flex-col space-y-2 text-sm'>
              ...
              <button className='bg-[#745CF6] p-4 flex items-center justify-center'>
                <PhoneIcon className='mr-2.5 text-white' />{' '}
